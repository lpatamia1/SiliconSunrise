...
Node* setupGame() {
    static Node startNode = {
        ...
        {
            {"Open the left door", "You find a library filled with ancient books.", {0, 1, 0}, NULL},
            {"Open the middle door", "You enter a dark hallway. At the end is a flickering light.", {0, 0, 1}, NULL},
            {"Open the right door", "You discover a room full of mechanical devices.", {1, 0, 0}, NULL}
        }
    };
    static Node libraryNode = {
        "You are in the library. There's a desk with a mysterious book on it.",
        {
            ...
            {"Leave the book", "You leave the book untouched and head back.", {0, 0, 0}, &startNode},
            {"", "", {0}, NULL}
        }
    };
    static Node hallwayNode = {
        "The hallway leads you to an underground lab.",
        {
            ...
            {"Return", "Feeling uneasy, you decide to return to the room.", {0, 0, 0}, &startNode},
            {"", "", {0}, NULL}
        }
    };
